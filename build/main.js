// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":61402}
"use strict";
(() => {
...
var $author$project$Main$AgainstTheClockMsg = function (a) {
	return {$: 'AgainstTheClockMsg', a: a};
};
var $elm$core$Platform$Sub$map = _Platform_map;
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$AgainstTheClock$Tick = {$: 'Tick'};
...
var $author$project$AgainstTheClock$Loading = {$: 'Loading'};
var $author$project$AgainstTheClock$GotMultiplication = function (a) {
	return {$: 'GotMultiplication', a: a};
};
...
var $author$project$Multiplication$Multiplication = F3(
	function (a, b, c) {
		return {$: 'Multiplication', a: a, b: b, c: c};
	});
...
var $author$project$AgainstTheClock$init = function (tables) {
	return _Utils_Tuple2(
		{remainingTime: 60, score: 0, state: $author$project$AgainstTheClock$Loading, tables: tables},
		$author$project$AgainstTheClock$generateMultiplication(tables));
};
var $author$project$Lives$Loading = {$: 'Loading'};
...
var $author$project$Lives$init = function (tables) {
	return _Utils_Tuple2(
		{lives: 3, score: 0, state: $author$project$Lives$Loading, tables: tables},
		$author$project$Lives$generateMultiplication(tables));
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$AgainstTheClock$GameOver = {$: 'GameOver'};
...
var $author$project$AgainstTheClock$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GotMultiplication':
				var multiplication = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: $author$project$AgainstTheClock$Playing(multiplication)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Select':
				var answer = msg.a;
				...
				switch (_v1.$) {
					...
					case 'Playing':
						...
						return _Utils_eq(answer, a * b) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{score: model.score + 1, state: $author$project$AgainstTheClock$Loading}),
							$author$project$AgainstTheClock$generateMultiplication(model.tables)) : _Utils_Tuple2(
							_Utils_update(
								model,
								{state: $author$project$AgainstTheClock$GameOver}),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				var newTime = model.remainingTime - 1;
...
var $author$project$Lives$GameOver = {$: 'GameOver'};
var $author$project$Lives$Playing = function (a) {
	return {$: 'Playing', a: a};
};
var $author$project$Lives$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotMultiplication') {
			var multiplication = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						state: $author$project$Lives$Playing(multiplication)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var answer = msg.a;
			...
			switch (_v1.$) {
				...
				case 'Playing':
					...
					return _Utils_eq(answer, a * b) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{score: model.score + 1, state: $author$project$Lives$Loading}),
						$author$project$Lives$generateMultiplication(model.tables)) : ((model.lives > 1) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{lives: model.lives - 1}),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{state: $author$project$Lives$GameOver}),
						$elm$core$Platform$Cmd$none));
				default:
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (_v3.$ === 'AgainstTheClock') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$AgainstTheClock(m)
							}),
			...
			case 'ClickLives':
				var _v5 = $author$project$Lives$init(model.tables);
				var m = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Main$LivesMsg, cmd));
			case 'ClickAgainstTheClock':
				var _v6 = $author$project$AgainstTheClock$init(model.tables);
				var m = _v6.a;
				var cmd = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'AddTable':
				var table = msg.a;
				var tables = A2($author$project$NonEmpty$append, table, model.tables);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tables: tables}),
...
var $author$project$Main$ClickAgainstTheClock = {$: 'ClickAgainstTheClock'};
var $author$project$Main$ClickHome = {$: 'ClickHome'};
var $author$project$Main$ClickLives = {$: 'ClickLives'};
...
var $author$project$UI$button = F2(
	function (attributes, _v0) {
		...
		var shadowColor = _v0.shadowColor;
		return A2(
					...
					A2(
						...
						function (_int) {
							return A2($author$project$NonEmpty$member, _int, tables) ? A2(
								...
								{
									backgroundColor: A3($author$project$Element$Extra$hsl, 130, 1, 0.38),
									label: $elm$core$String$fromInt(_int),
									onPress: $author$project$Main$RemoveTable(_int),
									shadowColor: A3($author$project$Element$Extra$hsl, 130, 1, 0.28)
								}) : A2(
								$author$project$UI$button,
								_List_fromArray(
									[
								...
								{
									backgroundColor: A3($author$project$Element$Extra$hsl, 0, 0, 0.5),
									label: $elm$core$String$fromInt(_int),
									onPress: $author$project$Main$AddTable(_int),
									shadowColor: A3($author$project$Element$Extra$hsl, 0, 0, 0.3)
								});
						},
						list));
			},
...
var $author$project$AgainstTheClock$view = F2(
	function (_v0, model) {
		var toParentMsg = _v0.toParentMsg;
		var onClickRestart = _v0.onClickRestart;
		var onClickHome = _v0.onClickHome;
		var _v1 = model.state;
		switch (_v1.$) {
			case 'Loading':
				return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(model.remainingTime)),
									A2(
							...
							A2(
								...
								function (n) {
									return A2(
										...
										{
											backgroundColor: A3($author$project$Element$Extra$hsl, 212, 1, 0.47),
											label: $elm$core$String$fromInt(n),
											onPress: toParentMsg(
												$author$project$AgainstTheClock$Select(n)),
											shadowColor: A3($author$project$Element$Extra$hsl, 207, 1, 0.32)
										});
								},
								list)),
							A2(
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX]),
							{
								backgroundColor: A3($author$project$Element$Extra$hsl, 345, 1, 0.47),
								label: 'Quitter',
								onPress: onClickHome,
								shadowColor: A3($author$project$Element$Extra$hsl, 340, 1, 0.32)
							})
						]));
			default:
				return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									{
										blur: 2,
										color: $author$project$Element$Extra$gray,
			...
			switch (_v0.$) {
				case 'Home':
					return A2(
						...
						_List_fromArray(
							[
								$author$project$Main$tablesView(model.tables),
								A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
											...
											]),
										{
											backgroundColor: A3($author$project$Element$Extra$hsl, 212, 1, 0.47),
											label: '3 vies',
											onPress: $author$project$Main$ClickLives,
											shadowColor: A3($author$project$Element$Extra$hsl, 207, 1, 0.32)
										}),
										A2(
										$author$project$UI$button,
											...
											]),
										{
											...
											onPress: $author$project$Main$ClickAgainstTheClock,
											shadowColor: A3($author$project$Element$Extra$hsl, 207, 1, 0.32)
										})
									]))
							]));
				case 'Lives':
					...
					return A2(
						...
						{onClickHome: $author$project$Main$ClickHome, onClickRestart: $author$project$Main$ClickLives, toParentMsg: $author$project$Main$LivesMsg},
						livesModel);
				case 'AgainstTheClock':
					var againstTheClockModel = _v0.a;
					return A2(
						$author$project$AgainstTheClock$view,
						{onClickHome: $author$project$Main$ClickHome, onClickRestart: $author$project$Main$ClickAgainstTheClock, toParentMsg: $author$project$Main$AgainstTheClockMsg},
